...
abstract class AbstractDnaVP extends AbstractVirtualPet
{
	...
	{
		return this.oVpDecoration.getDescription();
	}
	...
	{
		this.oVpDecoration.setDescription(new_description);
	}
	
	protected void addendDescription(String sAddendum)
	{
		this.oVpDecoration.setDescription(this.oVpDecoration.getDescription().concat(" ").concat(sAddendum));
	}
}
